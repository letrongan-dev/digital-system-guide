...
}(this, function (exports, bodyScrollLock) {
  'use strict'
  ...
  var __vue_render__ = function () {
    var _vm = this; var _h = _vm.$createElement; var _c = _vm._self._c || _h; return _c('transition', {attrs: {'name': 'cool-lightbox-modal'}}, [(_vm.isVisible) ? _c('div', {ref: 'coolLightbox', staticClass: 'cool-lightbox', class: _vm.lightboxClasses, style: (_vm.lightboxStyles), on: {'click': _vm.closeModal}}, [(_vm.gallery) ? _c('div', {staticClass: 'cool-lightbox-thumbs'}, [_c('div', {staticClass: 'cool-lightbox-thumbs__list'}, _vm._l((_vm.items), function (item, itemIndex) {
      return _c('button', {key: itemIndex,
        ...
        attrs: {'type': 'button'},
        on: {'click': function ($event) { _vm.imgIndex = itemIndex }}}, [(_vm.getMediaType(itemIndex) === 'video') ? _c('svg', {staticClass: 'cool-lightbox__thumb__icon', attrs: {'xmlns': 'http://www.w3.org/2000/svg', 'viewBox': '0 0 24 24'}}, [_c('path', {attrs: {'d': 'M6.5 5.4v13.2l11-6.6z'}})]) : _vm._e(), _vm._v(' '), _c('img', {attrs: {'src': _vm.itemThumb(_vm.getItemSrc(itemIndex), itemIndex), 'alt': ''}})])
